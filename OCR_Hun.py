...
# You need this if you created a exe file and the user
# Does not have tessaract installed. This includes the tessaract in 
...
for i in range(pageCount):
	...
	image = page.get_pixmap(dpi=dpiuser)
	...
	tesseract = 'tesseract "' + combined_pic + '" "' + combined_pic + '-ocr" -l hun+eng PDF' 
	#print(f'save_{i}.png'+' - image was scanned to PDF')
	os.system(tesseract)
	if (txtfileon.get()==1):
		tesseract = 'tesseract "' + combined_pic + '" "' + combined_saved + '-ocr" -l hun+eng txt' 
